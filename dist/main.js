...
const UIController = () => {
    ...
    const manageWeatherData = (place) => {
        ...
        const dailyWeatherData = _APIController__WEBPACK_IMPORTED_MODULE_0__["default"].getCurrentWeatherData(cityName);
