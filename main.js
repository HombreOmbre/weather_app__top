...
const UIController = () => {
    ...
    const showTodaysDataAndTime = () => {
        ...
        dateElem.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_1__["default"])(todaysDate, 'PPPP');

        timeElem.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_1__["default"])(todaysDate, 'p');
    };
    ...
    async function manageDailyWeatherData() {
        try {
            const dailyWeatherData = _APIController__WEBPACK_IMPORTED_MODULE_0__["default"].getWeatherData();
